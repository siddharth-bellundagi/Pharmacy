...
const Settings: React.FC = () => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => setPharmacySettings({ ...pharmacySettings, currency: e.target.value })}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          >
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setPharmacySettings({ ...pharmacySettings, taxRate: e.target.value })}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        </div>
      </div>
  ...
  const renderPrintingSettings = () => (
    <div className="space-y-6">
      <h3 className="text-lg font-medium text-gray-900">Printing Configuration</h3>
      ...
      <div className="space-y-4">
        <div className="flex items-center">
          <input
            ...
            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
          />
          <label htmlFor="printLogo" className="ml-2 block text-sm text-gray-900">
        ...
        <div className="flex items-center">
          <input
            ...
            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
          />
          <label htmlFor="printBarcode" className="ml-2 block text-sm text-gray-900">
